...
- [ ] **(T7)** Services fail to start (or refuse requests) when `Auth:DevBypass=true` outside Development; CI asserts `DevBypass=false` in all non-dev configs.
